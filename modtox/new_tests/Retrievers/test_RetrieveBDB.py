...
@pytest.mark.parametrize(
    "std_type_i,std_val_i,std_type,std_rel,std_val,std_unit",
    [
...
def test_normalize_standard_successful(
    ...
    """Tests standard is correctly normalized."""
    r = RetrieveBDB()
...
def test_parse_activity(mock):
    ...
    unparsed_act = {
        "query": "P23316",
        "monomerid": 50089546,
        "smile": "CC(C)(C)C#C\\C=C\\CNc1c(=O)ccc12",
        "affinity_type": "IC50",
        "affinity": 70,
        "pmid": 10888332,
