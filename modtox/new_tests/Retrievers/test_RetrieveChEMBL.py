...
from modtox.modtox.utils._custom_errors import (
    BadRequestError,
...
def test_normalize_standard_sucessful():
    ...
    unparsed_activity = {
        ...
        "molecule_chembl_id": "CHEMBL1791412",
        "standard_type": "K obs / 1",
        "standard_relation": "=",
        "standard_units": "M",
        "standard_value": "0.0000049",
    }
...
def test_parse_activity(mock):
    ...
    assert r.ids["InChI=1S/C3H6O/c1-3(2)4/h1-2H3"] == "CHEMBL1791412"
